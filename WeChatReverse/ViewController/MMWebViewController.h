...
@class BrandActionReportLogicController, CContact, EnterpriseConnectorLogic, JSConsoleViewController, MMAnimationTipView, MMJSApiVerifyMgr, MMScrollActionSheet, MMURLHandler, MMWebCustomLog, MMWebProgressBar, MMWebViewController_SwipeGestureGoBackHistory, MMWebViewPluginScheduler, MMWebViewPresetUI, NSCache, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSURLConnection, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UILongPressGestureRecognizer, UITapGestureRecognizer, UIView, UIView<YYWebViewInterface>, UIViewController, WCDeepLinkHandler, WCStatTimerHelper, WebViewA8KeyLogicImpl, WebViewJSLogicImpl, WebViewMenuCustomizeLogic, WebViewTimeProfileData, WebViewURLCheckLogic;
