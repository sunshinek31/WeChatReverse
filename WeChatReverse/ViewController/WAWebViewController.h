...
@class ForwardMessageLogicController, NSDictionary, NSMutableDictionary, NSMutableSet, NSString, UIColor, UILongPressGestureRecognizer, UIView, UIView<YYWebViewInterface>, WAIconActionSheet, WAWebViewJSLogicImpl, WAWebViewPluginScheduler;

@interface WAWebViewController : MMUIViewController <WAIconActionSheetDelegate, MMTipsViewControllerDelegate, WCActionSheetDelegate, WAWebErrorViewDelegate, UIGestureRecognizerDelegate, IUiUtilExt, WAContactMgrExtension, WAWebViewJSLogicDelegate, UIScrollViewDelegate, YYWebViewDelegate>
{
