...
@class CMessageWrap, ImageScrollView, MMProgressViewEx, MMTimer, MMToastViewController, MsgImgDataLogic, MsgImgFullScreenContainer, MsgImgPreviewData, NSMutableDictionary, NSMutableSet, NSOperationQueue, NSString, ScanQRCodeLogicController, ShareDataToOpenSDKController, UIActivityIndicatorView, UIButton, UIView, WCActionSheet;

@interface MsgImgFullScreenViewController : MMUIViewController <BaseScanLogicDelegate, WXVideoPlayerViewDelegate, WXVideoPlayerViewTouchDelegate, MsgImgDataLogicDelegate, UIViewControllerAnimatedTransitioning, MMToastViewControllerDelegate, WCActionSheetDelegate, UIAlertViewDelegate, MsgImgFullScreenContainerDelegate, IDownloadImageExt, IMsgExt, IMsgRevokeExt>
{
...
- (void)animateHideImageSaveAblumButton:(float)arg1;
