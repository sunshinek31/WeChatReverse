...
@class NSMutableArray, NSMutableDictionary, NSString, RichTextView, UIView, WCPayNewPaidOrderDetailView, WCPayPaidDetailQueryAwardCgi;
...
@interface WCPayPaidOrderDetailViewController : WCPayBaseViewController <WCPayPaidDetailQueryAwardCgiDelegate, WCPayNewPaidOrderDetailViewDelegate, ILinkEventExt, IWCPayPaidOrderActivityMgrExt>
{
    ...
    _Bool _bQueryingActivityInNewDetailView;
...
@property(nonatomic) _Bool bQueryingActivityInNewDetailView; // @synthesize bQueryingActivityInNewDetailView=_bQueryingActivityInNewDetailView;
...
- (void)viewDidLoad;
- (_Bool)statusBarFontOriginalWhite;
