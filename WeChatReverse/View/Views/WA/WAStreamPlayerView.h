...
@class AVPlayerItemVideoOutput, MMProgressViewEx, MMUIButton, MMUILabel, NSString, UIButton, UIColor, UIImageView, UILabel, WAFullVideoViewController, WAVideoLayer, WAVideoPlayerCore, WAWebViewController, WCNetworkMediaSlider;

@interface WAStreamPlayerView : UIView <WAVideoPlayerCoreDelegate, WAStreamPlayerInterface>
{
    ...
    _Bool _customThumb;
    WAFullVideoViewController *_vcFull;
    _Bool _pauseTemp;
    _Bool _showDanmu;
    _Bool _autoPlay;
    _Bool _afterView;
...
- (_Bool)isFullScreen;
- (void)updateThumbAndDuration:(id)arg1;
