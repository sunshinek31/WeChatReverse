...
@class AVPlayerItemVideoOutput, MMProgressViewEx, MMTimer, MMUIButton, MMUILabel, MMVideoPlayerCore, NSString, UIButton, UIColor, UIImageView, UILabel, WAFullVideoViewController, WAVideoLayer, WAWebViewController, WCNetworkMediaCore, WCNetworkMediaSlider;
