...
@optional
- (void)OnStayAtWeChat:(ShareMessageConfirmLogicHelper *)aShareMessageConfirmLogicHelper;
- (void)OnBackTo3rdApp:(ShareMessageConfirmLogicHelper *)aShareMessageConfirmLogicHelper;
