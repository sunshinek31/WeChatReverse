...
@class FTSWebSearchMgr, MMTagSearchBar, MMUIViewController, NSMutableArray, NSString, UIImageView, UISearchBar, UITextField, UIView, WASearchFromGlobalProxy, WSContactSearchLogic, WSJSEventHandler, WSResultViewLogic, WSTagSearchLogic;
