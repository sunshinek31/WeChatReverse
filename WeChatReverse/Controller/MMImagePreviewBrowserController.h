...
@class EditImageIntialView, MMAsset, MMLoadingView, MultiImageScrollView, NSMutableArray, NSMutableDictionary, NSString, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UIView;
