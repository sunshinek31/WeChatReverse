...
@class JSContext, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSThread, WAJSContextPluginScheduler, WAJSCoreServiceLaunchData, WAWebViewController;
...
@interface WAJSCoreService : NSObject <WAJSEventHandlerContextDelegate>
{
    ...
    WAJSCoreServiceLaunchData *_launchData;
    JSContext *_context;
    NSString *_appID;
...
@property(retain, nonatomic) WAJSCoreServiceLaunchData *launchData; // @synthesize launchData=_launchData;
...
- (void)setEnterPath:(id)arg1 withScene:(unsigned int)arg2 userData:(id)arg3;
