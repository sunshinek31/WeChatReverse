...
@class NSString, UINavigationController, WAAppTaskOpenParameter, WAAppTrialInfoLoader, WAContactGetter, WALoadingInfoData;
...
@interface WAAppContactPreLoader : MMService <MMService>
{
    ...
    WAAppTaskOpenParameter *m_taskOpenParameter;
...
- (void)openAppWithUserName:(id)arg1 navigationController:(id)arg2 fromScene:(unsigned long long)arg3 sceneNote:(id)arg4 pagePath:(id)arg5 debugMode:(unsigned long long)arg6 version:(unsigned int)arg7 showConfig:(id)arg8 userData:(id)arg9 onSuccess:(CDUnknownBlockType)arg10 onFailed:(CDUnknownBlockType)arg11;
...
- (void)openAppWithUserName:(id)arg1 appid:(id)arg2 navigationController:(id)arg3 fromScene:(unsigned long long)arg4 sceneNote:(id)arg5 pagePath:(id)arg6 version:(unsigned int)arg7 msgPackInfo:(id)arg8 showConifg:(id)arg9 userData:(id)arg10 onSuccess:(CDUnknownBlockType)arg11 onFaild:(CDUnknownBlockType)arg12;
- (void)launchOtherAppWithUserName:(id)arg1 pagePath:(id)arg2 debugMode:(unsigned long long)arg3 fromScene:(unsigned long long)arg4 sceneNote:(id)arg5 navigationController:(id)arg6 withReferrerInfo:(id)arg7 onSuccess:(CDUnknownBlockType)arg8 onFailed:(CDUnknownBlockType)arg9;
- (void)openAppWithJSONString:(id)arg1 fromScene:(unsigned long long)arg2 sceneNode:(id)arg3;
- (void)openAppWithQRFullUrl:(id)arg1 fromScene:(unsigned long long)arg2 onSuccess:(CDUnknownBlockType)arg3 onFailed:(CDUnknownBlockType)arg4;
- (void)reOpenAppWithUserName:(id)arg1 navigationController:(id)arg2 fromScene:(unsigned long long)arg3 sceneNote:(id)arg4 pagePath:(id)arg5 debugMode:(unsigned long long)arg6 version:(unsigned int)arg7 onSuccess:(CDUnknownBlockType)arg8 onFailed:(CDUnknownBlockType)arg9;
